...
const getUpcomingShifts: WebAPI.IRouteOptions<API.App.Schedule.GetUpcomingShifts.IEndpoint> = {
    method: "GET",
    url: "/api/schedule/upcoming-shifts",
    handler: async (req, res)=>{
        res.header("cache-control","private, no-cache");
        res.status(401);
        ...
        let result: API.App.Schedule.GetUpcomingShifts.IEndpoint["returnPacket"] = {
            status: "Failure",
            errCode: "NotSignedIn"
        }
