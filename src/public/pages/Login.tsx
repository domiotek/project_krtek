...
import WorkFriendsImg from "../assets/ilustrations/workFriends.svg";
import ForgotPasswordImg from "../assets/ilustrations/ForgotPassword.svg";
import UnderConstructionImg from "../assets/ilustrations/UnderConstruction.svg";
import EmailSentImg from "../assets/ilustrations/emailSent.svg";
    ...
    return (
        <div className={layoutClasses.MiddleBoxContainer}>
            <div className={layoutClasses.MiddleBox}>
                <div className={`${layoutClasses.Content} ${classes.ContentBox} ${activePanel=="PasswordRecoveryPanel"?classes.PasswordRecoveryHeightAdjust:""}`}>
                    ...
                    <div className={`${classes.AdditionalPanel} ${classes.PasswordRecoveryPanel} ${activePanel=="PasswordRecoveryPanel"?classes.Show:""}`}>
                        ...
                        <div className={classes.PanelContent}>
                            <img src={ForgotPasswordImg} alt="Forgotten password"/>
                    ...
                    <div className={`${classes.AdditionalPanel} ${classes.PasswordRecoveryEndPointPanel} ${activePanel=="PasswordRecoveryEndPointPanel"?classes.Show:""}`}>
                        <SubmenuHeader headerCaption="Password recovery" onBackCallback={()=>setActivePanel("HelpCenterPanel")} />
                        <div className={classes.PanelContent}>
                            <img src={EmailSentImg} alt="Email with a checkmark" />
                            <h3>Email sent</h3>
                    ...
                    <div className={`${classes.AdditionalPanel} ${classes.RegistrationInfoPanel} ${activePanel=="RegistrationInfoPanel"?classes.Show:""}`}>
                        ...
                        <div className={classes.PanelContent}>
                            <img src={WorkFriendsImg} alt="Friends at work"/>
                            <p>
                    ...
                    <div className={`${classes.AdditionalPanel} ${classes.ContactInfoPanel} ${activePanel=="ContactInfoPanel"?classes.Show:""}`}>
                        ...
                        <div className={classes.PanelContent}>
                            <img src={UnderConstructionImg} alt="Construction site"/>
                            <p>
